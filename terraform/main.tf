...
resource "kubernetes_config_map" "terraria_grafana_dashboards" {
  ...
  data = {
    "terraria-k8s-overview.json"      = file("${path.module}/dashboards/terraria-k8s-overview.json")
    "terraria-gameplay-overview.json" = file("${path.module}/dashboards/terraria-gameplay-overview.json")
  }
